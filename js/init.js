...
var msgSuccess = `<strong>Congratulations!</strong>&nbsp;Purchase made`
        ...
        if (payment[i].checked) {
            ...
            if (pay == 0) {
                ...
                if (email.trim() === "") {
                    ...
                    $("#modal-payment").css("height", "340px");
                    $("#SuccessPayment").removeClass("d-none");   
                    setTimeout(function () { $("#SuccessPayment").addClass("d-none"); $("#modal-payment").css("height","300px"); }, 3000);
                }
            } else {
                ...
                if (ID.trim() === "" || accNumber.trim() === "") {
                    ...
                    setTimeout(function () { $("#ErrorPayment").addClass("d-none"); $("#modal-payment").css("height", "360px"); }, 3000);
                        ...
                        $("#modal-payment").css("height", "450px");
                        $("#SuccessPayment").removeClass("d-none");   
                        setTimeout(function () { $("#SuccessPayment").addClass("d-none"); $("#modal-payment").css("height","360px"); }, 3000);
