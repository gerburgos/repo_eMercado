    ...
    for (let i = 0; i < currentCategoriesArray.length; i++) {
        ...
        if (((minCount == undefined) || (minCount != undefined && parseInt(category.cost) >= minCount)) &&
            ...
            htmlContentToAppend += `    
                             <div class="row">
                                   <div class"col-md-2">
                                    ...
                                    <div class="card-body">
                                         <h5 class="" id="carName">` + category.name + ` </h5>
            ...
            if (category.name === "Chevrolet Onix Joy") {
                ...
                htmlContentToAppend += `
                <a href="#2" class="btn btn-primary" id="btnVerMas" onclick="cancelFunction();">Ver más</a>
                <p class="text-muted" style="float:right; text-align: center;">` + category.soldCount + ` sold</p>
                </div>
                </div>
                </div>
...
function changeIcon(){
    if(estado == 1){
        document.getElementById("content_wrapper").style.left = "0";
        document.getElementById("content_wrapper").style.top = "40px";
        estado = 0;
    } else{
        document.getElementById("content_wrapper").style.left = "";
        document.getElementById("content_wrapper").style.top = "";
        estado = 1;
    }
}
